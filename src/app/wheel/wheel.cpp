...
#define WHEEL_FRONT_RIGHT_MOVE_FORWARD(x) {BLD300B_driver3_set_direction(BLD300B_DIRECTION_FORWARD);BLD300B_driver3_set_duty(x);}
#define WHEEL_FRONT_LEFT_MOVE_FORWARD(x) {BLD300B_driver2_set_direction(BLD300B_DIRECTION_REVERSED);BLD300B_driver2_set_duty(x);}
#define WHEEL_BACK_RIGHT_MOVE_FORWARD(x) {BLD300B_driver5_set_direction(BLD300B_DIRECTION_FORWARD);BLD300B_driver5_set_duty(x);}
#define WHEEL_BACK_LEFT_MOVE_FORWARD(x) {BLD300B_driver4_set_direction(BLD300B_DIRECTION_REVERSED);BLD300B_driver4_set_duty(x);}

#define WHEEL_FRONT_RIGHT_MOVE_BACKWARD(x) {BLD300B_driver3_set_direction(BLD300B_DIRECTION_REVERSED);BLD300B_driver3_set_duty(x);}
#define WHEEL_FRONT_LEFT_MOVE_BACKWARD(x) {BLD300B_driver2_set_direction(BLD300B_DIRECTION_FORWARD);BLD300B_driver2_set_duty(x);}
#define WHEEL_BACK_RIGHT_MOVE_BACKWARD(x) {BLD300B_driver5_set_direction(BLD300B_DIRECTION_REVERSED);BLD300B_driver5_set_duty(x);}
#define WHEEL_BACK_LEFT_MOVE_BACKWARD(x) {BLD300B_driver4_set_direction(BLD300B_DIRECTION_FORWARD);BLD300B_driver4_set_duty(x);}
