...
BLD300B_at_fault_cb_t _BLD300B_at_fault_2_cb = NULL;
BLD300B_at_NoFault_cb_t _BLD300B_at_NoFault_2_cb = NULL;
...
{
    bool fault_happenned = (digitalRead(DRIVER_2_ALARM_PIN) == 0);
    fault_happenned ? _BLD300B_at_fault_2_cb() : _BLD300B_at_NoFault_2_cb();
}
...
void BLD300B_driver2_init(BLD300B_at_fault_cb_t BLD300B_at_fault_cb, BLD300B_at_NoFault_cb_t BLD300B_at_NoFault_cb)
{
        // set callback
    _BLD300B_at_fault_2_cb = BLD300B_at_fault_cb;
    _BLD300B_at_NoFault_2_cb = BLD300B_at_NoFault_cb;
